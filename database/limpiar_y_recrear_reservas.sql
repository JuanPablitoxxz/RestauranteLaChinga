-- Script para limpiar y recrear completamente las tablas de reservas
...
-- 4. Eliminar funciones si existen
...
-- 8. Crear función para actualizar fecha_actualizacion
...
-- 10. Crear función para limpiar usuarios temporales expirados
