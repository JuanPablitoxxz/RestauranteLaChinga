-- Script para crear la tabla de reservas y usuarios temporales
...
ADD COLUMN IF NOT EXISTS reserva_id INTEGER REFERENCES reservas(id);
...
-- Crear política RLS para reservas (opcional, deshabilitar si causa problemas)
